...
type SubscriptionPlan struct {
	...
	PurchaseLink   string `json:"purchase_link" gorm:"type:varchar(1024);default:''"`
...
func CompleteSubscriptionOrder(tradeNo string, providerPayload string, callerIp string, expectedPaymentProvider string, actualPaymentMethod string) error {
	if tradeNo == "" {
	...
	if logUserId > 0 {
		...
		RecordTopupLog(logUserId, msg, callerIp, logPaymentMethod, actualPaymentMethod)
	}
	return nil
}
